"use strict";var i=function(r,u){return function(){try{return u||r((u={exports:{}}).exports,u),u.exports}catch(c){throw (u=0, c)}};};var b=i(function(R0,I){
...
var _=require('@stdlib/math-base-assert-is-nan/dist'),$=require('@stdlib/math-base-assert-is-infinite/dist'),x=require('@stdlib/math-base-special-abs/dist'),f=require('@stdlib/math-base-special-ln/dist'),r0=require('@stdlib/math-base-special-trunc/dist'),e0=require('@stdlib/math-base-special-sinpi/dist'),a0=require('@stdlib/constants-float64-pi/dist'),q=require('@stdlib/constants-float64-pinf/dist'),t0=b(),i0=N(),u0=g(),v0=m(),s0=h(),n0=O(),l0=R(),o0=U(),f0=Y(),p0=j(),c0=.07721566490153287,y0=.3224670334241136,q0=1,T0=-.07721566490153287,C0=.48383612272381005,I0=-.1475877229945939,b0=.06462494023913339,A0=-.07721566490153287,N0=1,W0=.4189385332046727,y=1.4616321449683622,g0=4503599627370496,k0=72057594037927940,m0=13877787807814457e-33,z=1.4616321449683622,w0=-.12148629053584961,h0=-3638676997039505e-33;function F0(r){var u,c,v,T,n,l,o,C,p,s,e,a,t;if(_(r)||$(r))return r;if(r===0)return q;if(r<0?(u=!0,r=-r):u=!1,r<m0)return-f(r);if(u){if(r>=g0||(p=e0(r),p===0))return q;c=f(a0/x(p*r))}if(r===1||r===2)return 0;if(r<2)switch(r<=.9?(t=-f(r),r>=y-1+.27?(e=1-r,v=0):r>=y-1-.27?(e=r-(z-1),v=1):(e=r,v=2)):(t=0,r>=y+.27?(e=2-r,v=0):r>=y-.27?(e=r-z,v=1):(e=r-1,v=2)),v){case 0:a=e*e,l=c0+a*t0(a),n=a*(y0+a*i0(a)),o=e*l+n,t+=o-.5*e;break;case 1:a=e*e,s=a*e,l=C0+s*s0(s),n=I0+s*n0(s),T=b0+s*l0(s),o=a*l-(h0-s*(n+e*T)),t+=w0+o;break;case 2:l=e*(A0+e*o0(e)),n=N0+e*f0(e),t+=-.5*e+l/n;break}else if(r<8)switch(v=r0(r),e=r-v,o=e*(T0+e*v0(e)),C=q0+e*u0(e),t=.5*e+o/C,a=1,v){case 7:a*=e+6;case 6:a*=e+5;case 5:a*=e+4;case 4:a*=e+3;case 3:a*=e+2,t+=f(a)}else r<k0?(p=f(r),a=1/r,e=a*a,s=W0+a*p0(e),t=(r-.5)*(p-1)+s):t=r*(f(r)-1);return u&&(t=c-t),t}M.exports=F0
